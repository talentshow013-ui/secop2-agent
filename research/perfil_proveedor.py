...
ct = c.get("jbjy-vk9h", where=f"documento_proveedor='{NIT}'", select="nombre_entidad,departamento,objeto_del_contrato,tipo_de_contrato,modalidad_de_contratacion,estado_contrato,valor_del_contrato,fecha_de_firma,fecha_de_inicio_del_contrato,fecha_de_fin_del_contrato,proveedor_adjudicado,nombre_representante_legal", order="fecha_de_firma DESC", limit=200)
